...
func (s *stubAdminService) ListAccounts(ctx context.Context, page, pageSize int, platform, accountType, status, search string, groupID int64, createdFrom, createdTo *time.Time) ([]service.Account, int64, error) {
