...
func (m *sessionWindowMockRepo) ListWithFilters(context.Context, pagination.PaginationParams, string, string, string, string, int64, *time.Time, *time.Time) ([]Account, *pagination.PaginationResult, error) {
	panic("unexpected")
}
