export default {
  ...
  nav: {
    ...
    accounts: 'Accounts',
    accountBatchManager: 'Batch Accounts',
    proxies: 'Proxies',
  ...
  keys: {
    ...
    importToSpectrAi: 'Import to SpectrAI',
    enable: 'Enable',
    disable: 'Disable',
    nameLabel: 'Name',
    ...
    spectrAiNotInstalled: 'SpectrAI is not installed or the protocol handler is not registered. Please install the latest SpectrAI first, or create the provider manually on the AI Models page.',
    ccsClientSelect: {
      title: 'Select Client',
  ...
  admin: {
    ...
    accounts: {
      ...
      batchManager: {
        ...
        description: 'Handle newly added accounts in one place: filter by created time, apply notes, set runtime state, configure scheduled tests, and run availability checks.',
        selectionInfo: '{count} account(s) selected',
        selectCurrentPage: 'Select current page',
        clearSelection: 'Clear selection',
        reload: 'Reload',
        notesTitle: 'Batch Notes',
        notesHelp: 'Overwrite notes for the currently selected accounts.',
        notesPlaceholder: 'e.g. Imported on 2026-03-21',
        applyNotes: 'Apply Notes',
        notesApplied: 'Notes updated: {success} succeeded, {failed} failed',
        stateTitle: 'Batch State',
        stateHelp: 'Quickly mark accounts as normal, error, rate limited, temp unschedulable, or overloaded.',
        reasonPlaceholder: 'Optional state reason / error message',
        durationMinutes: 'Duration in minutes',
        applyState: 'Apply State',
        stateApplied: 'State updated: {success} succeeded, {failed} failed',
        scheduleTitle: 'Batch Scheduled Tests',
        scheduleHelp: 'Create or update the first scheduled test plan for each selected account.',
        modelPlaceholder: 'Optional test model, leave blank for default',
        cronPlaceholder: 'e.g. 0 * * * *',
        applySchedule: 'Apply Schedule',
        scheduleApplied: 'Scheduled tests updated: {success} succeeded, {failed} failed',
        availabilityTitle: 'Bulk Availability Check',
        availabilityHelp: 'Runs account tests in sequence. Failed accounts are automatically marked as error.',
        runAvailabilityCheck: 'Run Bulk Check',
        checkingProgress: 'Progress: {done}/{total}',
        checkCompleted: 'Bulk check finished. All {total} account(s) are available.',
        checkCompletedWithErrors: 'Bulk check finished. Checked {total} account(s), {failed} failed.',
        checkFailedAccountsMarkedError: '{count} failed account(s) were marked as error',
        checkRequestFailed: 'Bulk availability check failed, please try again later',
        tableEmpty: 'No accounts found for the current filters',
        columns: {
